...
//       try {
//         // Try Viem-based basename resolution first (more reliable for Base names)
//         const viemBasename = await resolveBasename(address as `0x${string}`);
//         if (viemBasename) {
//           setBaseName(viemBasename);
//           return;
//         }

//         // Fallback to OnchainKit for ENS names
